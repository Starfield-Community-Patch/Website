...
export default function MissionPage() {
    return (
        <div>
            ...
            <div className='mb-4'>
            The project uses the <b>[TBC!]</b> license which means the patch itself is open source, but any mods that depend it are welcome to use any permissions or license defined by the mod author.
            </div>
            <div className='mb-4'>
